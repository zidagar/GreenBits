...
public abstract class Network {
    public final static NetworkParameters NETWORK = NetworkParameters.fromID(NetworkParameters.ID_ALPHANET);
    public final static String GAIT_TOKEN_URL = "https://alpha.greenaddress.it/token/";
    ...
    public final static boolean isCTEnabled = true;
    public final static boolean isSchnorrEnabled = true;
}
